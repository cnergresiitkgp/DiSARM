...
?>
      ...
      <?php if (isset($_SESSION['username'])) {?>
		 <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right" id = "info_table">
	...
	<?php	}
		...
		<?php	}
				...
				<li> <a href="locate_agency.php" class="dropdown-toggle"><i class="fa fa-map-marker"></i> Locate missing person</a></li>
...
<div class="container">
    ...
    <div class="title"><h1>Situational Information</h1></div>
    
</div>
</div><!-- end page title -->
<?php if(isset($_SESSION['username'])){?>
<?php if($role_select == 'Agencies') { ?>    
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href = "agency.php" >&laquo; RETURN TO HOME PAGE</a>
<?php } elseif ($role_select == 'Volunteers') { ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href = "volunteer.php" >&laquo; RETURN TO HOME PAGE</a>
<?php } elseif ($role_select == 'Admin') { ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href = "admin.php" >&laquo; RETURN TO HOME PAGE</a>
<?php }  else { ?>
...
<div class="container">
      ...
      <fieldset>
     	  <?php
							...
							print("<tr class=\"table-list\"><th width='55%'>Situational Information</th>");
							print("<th width='30%'>Location</th>");
							print("<th>Timestamp</th>");
							if($query_cons->num_rows==0)
								print("<tr class=\"table-list\"><th colspan=3>No situational information is available at the moment</th></tr></table><br>");
							else
							{
								while($row1 = $query_cons->fetch_assoc())
								{
									...
									print("<tr class=\"table-list\"><td>".$msg."</td>");
									print("<td>".$loc."</td>");
									print("<td>".$time."</td>");
								}
								print("</table><br>");
    ...
    $(function()
    {
        ...
        {                   
            ...
            messages:
            {
				...
				resource1:
                {
                    required: 'Please Specify Resource',
				},
				unit1:
				{
				...
				subject:
				{
					required: 'Specify the Type of Service you have to offer'
				},
				message:
				{
					required: 'Illustrate the service you can offer'
				},
				othr:
				{
					required: 'Fill this up to submit'
				}
