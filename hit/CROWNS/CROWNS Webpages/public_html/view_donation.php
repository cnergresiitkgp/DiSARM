...
<!--				<tr class="table-list">
			...
			<table class="table-style" id="admin_table">
				...
				<tr class="table-list">
					<td width='50%'><b><a href="view_donation.php"><font color="#444444"><i class="fa fa-angle-right"></i>Manage Donations</a></b></td>
				</tr>
				<tr class="table-list">
					<td width='50%'><b><a href="rapid.php">RAPID</a></b></td>
				</tr>
...
.scrollit {
	...
	width: 900px;
	  ...
	  <form action = "filter_donation.php" method = "POST" onsubmit = "return tableSubmi()">
...
<?php
/*$sql = "SELECT DISTINCT donate_master.id, donate_master.donated_by, donate_master.contact_no, donate_master.resource_name, 
donate_master.resource_unit, donate_master.resource_amount, donate_master.resource_others, donate_master.address, state.state, 
district.district, block.block, panchayat_municipalaty.panchayat, village.village FROM donate_master, state, district, block, 
panchayat_municipalaty, village where state.id = donate_master.state AND district.id = donate_master.district AND 
block.id = donate_master.block AND panchayat_municipalaty.id = donate_master.panchayat_municipality AND 
village.id = donate_master.village_area";
//echo $sql;
...
$address = $output['state']." ". $output['district']." ".$output['block']." ".$output['panchayat']." ".$output['village'];
//echo $address;
$donation_details = $output['resource_unit']." ".$output['resource_amount']." ".$output['resource_others'];*/
//echo $donation_details;
//die;
$sql = "SELECT * FROM `donate_master` WHERE `is_checked` = 'y'";
