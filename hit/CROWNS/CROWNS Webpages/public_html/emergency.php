                      ...
                      <div class="container">
                        ...
                        <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
                          <ul class="nav navbar-nav">
                            ...
                            <li> <a href="emergency.php" class="active"><i class="fa fa-flag"></i> Report An Emergency</a></li>
...
{  
	...
	return true; 
              ...
              <form id="sky-form" class="sky-form" name = "form1" onsubmit ="return validateForm(this);" action = "emergency_insert.php" method = "post" style="<?php if($flag == true){echo 'display: none;';} else '' ;?>">
                <div class="one_third">
                  <!--                <form id="sky-form" class="sky-form" action = "abc.php" method = "post">-->
                  <header><strong>Enter Your Details</strong></header>
                  <fieldset>
                    <div class="row">
                    ...
                    <section>
					  ...
					  <?php } else{ ?>					  
                      <input type="text" name="con_number" placeholder="Contact No" required>
					  <?php } ?>
                  ...
                  <fieldset>
                    <section>
                      <label class="label">Report Problem</label>
                ...
                <div class="two_third last" style="margin-left:45px;">
                  <div class="cforms">
                    ...
                    <header> <strong>Enter Details of the Location You Want to Report</strong></header>
                    <fieldset>
                      <div class="row">
                        <div class="row">
                          <section class="col col-6">
                        ...
                        <section >
                          <label class="select">
                            <select name="location">
                              <option value="0" selected disabled>Are You Presently There ?</option>
                        ...
                        <section>
                          <label class="label">Upload Media</label>
                          <label class="input"> <i class="icon-append icon-file"></i>
                          <input type="file" name="subject" id="subject">
                          </label>
                        </section>
                        <footer>
                          <button type="submit" class="button" name = "submit" id = "sub" value="Submit">Submit</button>
                        </footer>
                      </div>
                    </fieldset>
