                  ...
                  <div class="container">
                    ...
                    <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
                      <ul class="nav navbar-nav">
                        ...
                        <li> 
                          <a href="impcon.php" class="dropdown-toggle">
                            <i class="fa fa-star">
                            </i> Important Contacts
                          </a>
                        </li>
                        <li> 
                          <a href="helpme.php" class="active">
                            <i class="fa fa-medkit">
                            </i> Help Me
                          </a>
                        </li>
                        <li> 
                          <a href="emergency.php" class="dropdown-toggle">
                            <i class="fa fa-flag">
                            </i> Report an Emergency
                          </a>
                        </li>
                        <li> 
                          <a href="locate.php" class="dropdown-toggle">
            ...
            <div class="one_third">
              ...
              <fieldset>
                ...
                <section>
                  <label class="input">
				  <?php  if(isset($_SESSION['username'])){  ?>
					<input type="text" name="address" placeholder="PIN Code" value="<?php echo $donor_pincode; ?>" required>
				  <?php } else { ?>
					<input type="text" name="address" placeholder="PIN Code" required>
				  <?php } ?>	
