...
$sql = "SELECT resource_request.Req_id, resource_request.resource_name, resource_request.quantity, resource_request.importance, resource_request.Requisition_Date, 
resource_request.requested_by, resource_request.contact_no, resource_request.Affiliation, resource_request.landmark, state.state, district.district, block.block, 
panchayat_municipalaty.panchayat, village.village FROM resource_request JOIN state, district, block, panchayat_municipalaty, village
WHERE resource_request.state=state.id AND resource_request.district=district.id AND resource_request.block=block.id AND resource_request.panchayat_municipality=panchayat_municipalaty.id 
AND resource_request.village_area= village.id";
