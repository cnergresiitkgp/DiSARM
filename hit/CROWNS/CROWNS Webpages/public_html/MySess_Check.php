...
<header id="header">
	...
	<div class="wrapper">
        ...
        <li> <a href="logout.php" class="dropdown-toggle"><i class="fa fa-lock"></i> LogOut</a></li>
        <?php }
		else {?>
...
<div class="container">
    ...
    <div class="rw-wrapper">
        <div class="rw-sentence">
			...
			$sel = $conn->query("SELECT role FROM register_master WHERE email = '$username'");
			while($row = $sel->fetch_array()){
			$rol = $row[0];
			}
			if($rol == "Admin"||"Donor" ||"Agencies"||"Volunteers")
			{ 
				if(($rol == "Agencies")||($rol == "Volunteers")||($rol == "Admin")){
					
			?>	
			<script>
				 window.location.href = 'donate_agency.php';
				 </script>
			<?php		
				}
				else{
		  ?>
            ...
            <div class="rw-words rw-words-1">
                <span>Visitor needs to login for donating resources </span>
                <span>Visitor needs to login for services</span>
    ...
    <a href="MyLogin.php" class="animate" data-anim-type="fadeInRight">Login Now</a>
