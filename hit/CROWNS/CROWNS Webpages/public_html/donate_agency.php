...
if($role_select == 'Volunteers'){// echo "hello";?>
                        ...
                        <li> 
                          <a href="MySess_Check.php" class="active">
                            <i class="fa fa-money">
                            </i> Donate
                          </a>
                        </li>
...
$agencyId = $result["id"];	
$agencyFname = $result["firstname"];
$agencyLname = $result["lastname"];
...
for(var i=0; inputElements[i]; ++i){
	...
	return true; 
      ...
      <form action="donate_insert.php" id="sky-form" method="post" name = "form1" onsubmit = "return validateForm(this);" class="sky-form" style="<?php if($flag == true){echo 'display: none;';} else '' ;?>">
        <div class="one_forth">
          <header>
          ...
          <fieldset>
            <div class="row">
              <section class="col col-6">
                <label class="input">
                  <input type="text" name="firstname" placeholder="First name" value="<?php echo $agencyFname; ?>" required>
                </label>
              </section>
              <section class="col col-6">
                <label class="input">
                  <input type="text" name="lastname" placeholder="Last name" value="<?php echo $agencyLname; ?>" >
                </label>
              </section>
            </div>
            <section>
              <label class="input">
                ...
                <input type="text" name="con_number" placeholder="Contact No" value="<?php echo $contactno; ?>" required>
            ...
            <section>
              <label class="input">
                <input type="text" name="address" placeholder="PIN Code" value="<?php echo $landmark;?>" required>
              </label>
            </section>
            <!--	</fieldset>
<fieldset>  -->
...
<!-- end section -->
<!--	<div class="one_fourth" style="margin-left:45px;">-->
<header> 
  <label style="cursor: pointer; margin-left: 27%; cursor: pointer;">
    <input type="radio" name="gender" id = "resource" value="resour" class="sky-form" />
    <strong>&nbsp;&nbsp;Donate Resource
    </strong>
  </label>
  <label style="margin-left: 17%; cursor: pointer;">
    <input type="radio" name="gender" id = "resource2" value="service" class="sky-form" />
    <strong>&nbsp;&nbsp;Donate Service
    </strong>
  </label>
</header>
<fieldset>
  <div class="row">
    ...
    <section class="col col-6 col-xs-6" id = "sel12">
      <label class="select" id = "sel11" style="display:none">
        <select name="unit_1" id="unit1" style="display:none">
          ...
          <option value="kg" id = "kg" style="display:none">kg
          </option>
          <option value="quintal" id = "quintal" style="display:none">quintal
          </option>
		  <option value="packets" id = "packets" style="display:none">Packets
            </option>
          <!--		<option value="meter" id = "meter" style="display:none">quintal</option>-->
    ...
    <section class="col col-6 col-xs-6">
      <label class="label" id = "spec" style="display:none">
      </label>
      <label class="input"> 
        <input type="text" name="quan" id="quan" min = "1" placeholder="Specify Quantity" onkeyup="myFunction()" style="display:none">
      </label>
    </section>
    <section class="col col-6 col-xs-6">
...
for(var i=0; inputElements[i]; ++i){
	  ...
	  return false;
        ...
        <section class="col col-6 col-xs-6" style = "margin-left: 50%;">
