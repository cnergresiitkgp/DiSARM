...
<div class="container">
    ...
    <div class="content_fullwidth lessmar">
      ...
      <?php
			...
			$data = "SELECT `volunteer_id`, `work_block`, `work_panchayat`, `work_village`, `is_deleted` FROM `volunteer_master` WHERE `volunteer_id` = '".$volunteer_id."'";
			//echo  $data; 
      ...
      <div class="three_fourth last">
		   ...
		   <input type="hidden" name="id" id="id" value="<?php echo $volunteer_id;?>">
					<div class = "row">
						...
						<br><br><br>
					<div class = "row">	
						<section class="col col-6 col-xs-6" style = "float: center; margin-left: 75px;">
								<input type="submit" class="button" name = "sub" id = "sub" value="Reassign">
						</section>	
