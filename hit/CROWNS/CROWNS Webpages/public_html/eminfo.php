...
<div class="container">
    ...
    <div class="title"><h1>Emergency Notifications</h1></div>
...
<div class="container">
      ...
      <fieldset>
     	  <?php
							...
							print("<tr class=\"table-list\"><th width='10%'>Notification ID</th>");
							print("<th>Type</th>");
							print("<th width='60%'>Message</th>");
							print("<th>Timestamp</th>");
							if($query_cons->num_rows==0)
								print("<tr class=\"table-list\"><th colspan=5>No emergency notifications are available at the moment</th></tr></table><br>");
							else
							{
