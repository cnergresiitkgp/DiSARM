...
<header id="header">
    ...
    <div class="container">
      ...
      <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
        ...
        <li> <a href="report.php" class="dropdown-toggle"><i class="fa fa-flag"></i> Report Emergency</a></li>
        <li> <a href="locate.php" class="dropdown-toggle"><i class="fa fa-map-marker"></i> Locate Victim</a></li>
        <li> <a href="donate.php" class="dropdown-toggle"><i class="fa fa-money"></i> Donate</a></li>
        </ul>
...
?>
	...
	<script>
		...
		<tr>
			<td><?php  echo $result_contact["volunteer_id"];  ?></td>
			<td><?php  echo $result_contact["volunteer_name"];  ?></td>
			<td><?php  echo $track_state,$district_value,$track_block,$track_panchayat,$track_village;?></td>
			<td><?php  echo $result_contact["contact_number"];?></td>
			<td><?php  echo $result_contact["Affiliation"];?></td>
			
			<td><?php  echo $result_contact["skills"];?></td>
			<td><?php  echo $track_address1;?></td>
			<td> 
				<a href="workplace_edit_volunteer_admin.php?id=<?php echo $result_contact["volunteer_id"];?>">Reassign</a>&nbsp;&nbsp;
				<a href="edit_volunteer_admin.php?id=<?php echo $result_contact["volunteer_id"];?>">Edit</a>&nbsp;&nbsp;
	...
	<br>
<div>
	  <form action="add_volunteer_admin.php" id="sky-form" method="post">
