...
{  
	...
	return true; 
      ...
      <div class="cforms">
        <form action="locate_missing_entry_insert.php" method="post" id="sky-form" name = "form1" onsubmit ="return validateForm(this);" class="sky-form" style="<?php if($flag == true){echo 'display: none;';} else '' ;?>">
          <header>
