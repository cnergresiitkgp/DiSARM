...
/*	if(!formObj.email.value.match(email)) {  
	...
	return true; 
      ...
      <div class="three_fourth last">
       ...
       <form action="edit_volunteers_insert.php" id="sky-form" method="post" onsubmit ="return validateForm(this);" class="sky-form" style="<?php if($flag == true){echo 'display: none;';} else '' ;?>">
	   <input type="hidden" name="id" id="id" value="<?php echo $volunteer_id;?>">
	   <h3 style = "display: block;background-color:#000; color:#FFF; text-align:center;"><b><center>Edit Volunteer Details</center></b></h3>
	   <div>
	   <fieldset>
		   <div class="row">
		   &nbsp;&nbsp &nbsp;&nbsp
				<section class = "col col-6">
					...
					<label class="input" style = "margin:right">Contact Number</label>
