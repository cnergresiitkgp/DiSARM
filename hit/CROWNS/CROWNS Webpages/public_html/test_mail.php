...
<?php
       $firstName = $_SESSION['firstname'];
			  ...
			  while($result_data = $get_data->fetch_array()){
				  ...
				  //$agency_email = $result_data["email"];
...
<?php }}?>
	...
	//		while($result = mysql_fetch_assoc($get_data)){
      ...
      <div class="three_fourth last">
		  ...
		  <form name="contact" action="test_mail_insert.php" method="post">

		<table width="70%">

<!--		<tr>

                  <td width="35%" align="right" class="form"><font color="#FF0000">

							  &nbsp;*&nbsp;&nbsp;</font>To&nbsp; </td>

                  <td width="50%">

							  <input name="to" style="width: 200px;" type="text"></td>
                ...
                <tr>
                  ...
                  <td width="50%">
							  ...
							  <input name="fname" style="width: 200px;" type="text" placeholder = "<?php echo $name;?>"></td>
...
<!--                <tr>
                  ...
                  <td><input name="address" style="width: 200px;" type="text"></td>

                </tr>-->

                <tr>

                  <td align="right" class="form"><font color="#FF0000">

							  </font>Phone&nbsp; </td>

                  <td><input name="phone" style="width: 200px;" type="text" id="phone" placeholder = "<?php echo $phone;?>"></td>
...
<!--             <tr>
                  ...
                  <td><input name="email" style="width: 200px;" type="text"></td>

                </tr>-->

                <tr>

                  <td align="right" class="form">Subject&nbsp;</td>

                  <td><input name="subject" placeholder = "Work location change notification" style="width: 200px;" type="text"></td>

                </tr>

        <!--        <tr>

            <td valign="top" align="right" class="form"><font color="#FF0000">

							  &nbsp;*&nbsp;&nbsp;</font>Feedback&nbsp;</td>

                  <td>

			<textarea name="feedback" id="feedback"cols="30" style="height: 100px; width: 200px;"></textarea>                                         
                ...
                <tr>
                  ...
                  <td colspan="2" align="right" style="padding:0 15px 0 0;">

                    <input name="send" class="form_bttn" value="Send" type="submit" ></td>

                </tr>

                <tr>

                  <td colspan="2" align="right" height="25" style="padding:0 5px 0 0;" class="form">&nbsp;&nbsp;Fields marked with ( <font color="#FF0000">*</font> ) are compulsory. 
