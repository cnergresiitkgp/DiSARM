...
<!-- just remove the below comments witch bg patterns you want to use --> 
 ...
 <style>
	#dataTable { border: 1px solid black; margin-top: 10px;center;}
    ...
    <div class="container">
      ...
      <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
       ...
       <ul class="nav navbar-nav">
        ...
        <li> <a href="locate.php" class="active"><i class="fa fa-map-marker"></i> Locate missing person</a></li>
...
<div class="container">
    ...
    <div class="title"><h1>Locate Missing Person</h1></div>
...
{  
	...
	return true; 
        ...
        <form action="" method="post" id="sky-form" class="sky-form" name = "form1" onsubmit ="return validateForm(this);">
            ...
            <footer>
            <button type="submit" class="button" name = "submit" id = "submit">Locate</button>
      ...
      <div class="two_third last">       
            ...
            <header> <strong><center>Search All Missing Persons</center></strong></header>
             <section>
             
            <button class="button" id = "submitall" name = "submitall">Locate All</button>
...
// Check if image file is a actual image or fake image
	...
	else
	{
        ...
        <div class="two_third last">
		<br><br><br>
          <h3 style="background-color:#000; color:#FFF; text-align:center;" id="tblHd"><strong>Result of Your Request</strong></h3>    
         <table width = 100% id = "dataTable" name = "dataTable">
        ...
        <?php while($row = $get_result->fetch_array()){ 
		//print_r ($row);
		?>
